<template>
  <div id="app">
    <h2>ViewCore-360 Example</h2>
    <div class="player-container">
      <vue-core-video-player src="/videos/avengers.mp4" :viewCore="viewCore"></vue-core-video-player>
    </div>
    <p>
      <a class="btn-view-code" href="https://github.com/core-player/viewcore-360">
    ...
    <p class="footer">
      Source From 
      <a href="https://www.youtube.com/watch?v=HNOT_feL27Y&list=RDQMjcZ9JlTHzgE&index=1">
